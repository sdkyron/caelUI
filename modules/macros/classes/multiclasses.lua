...
multiClasses = {
	...
	["Hadés"] = {
		...
		body = [=[/run SendChatMessage("<Hadés> (3/13 Mythique) recrute: Rogue, DK, Mage, Druide (Equi et Resto). Raids Jeu, Dim, Lun de 20h45 à 23h30. N'hésitez pas à nous contacter.", "CHANNEL", nil, (IsResting() or string.find(GetMapInfo(), "garrisonff") or GetMapInfo() == "AshranHordeFactionHub") and 2 or 1)]=],
		blizzmacro = true,
	},
}
